...
module.exports = {
    async index(req, res) {
        ...
        const getOrdersPromise = orders.map(async order => {
            order.product = await LoadProductService.load('products', { where: {
                id: order.product_id
            }})
            ...
            order.formattedUpdatedAt = `
                ${order.formattedStatus} em ${updatedAt.day}/${updatedAt.month}/${updatedAt.year} às ${updatedAt.hour}:${updatedAt.minutes}
            `
        ...
        try {
            ...
            const createOrdersPromise = filteredItems.map(async item => {
                ...
                await mailer.sendMail({
                    ...
                    subject: 'Novo pedido de comprado',
